...
public class MainActivity extends AppCompatActivity {
    ...
    //tells us if timer is running or not
    private boolean mTimerRunning;//null
    ...
    private void resetTimer() {
        ...
        updateCountDownText();//set text back to orginal time
        mButtonReset.setVisibility(View.INVISIBLE);
    ...
    private void updateCountDownText() {
        ...
        //formats the string to 00:00 for the countdown text view
